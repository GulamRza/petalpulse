...
export async function generateMetadata({ params }: { params: Promise<{ userId: string }> }): Promise<Metadata>{
  ...
  return {
    title: user?.name + ' | Profile' || 'Profile',
    description: "Plant enthusiast. Lover of all things green 🌱."
  }
}
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <div className="bg-green-500 dark:bg-green-700 p-6">
        <div className="max-w-5xl mx-auto flex flex-col gap-6">
          ...
          {(session?.user.id == user.id) && <div className=" flex gap-4">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div>
          {user.threads.map((thread : any) => (
            <div
              key={thread.id}
              className="p-4 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-600"
            >
